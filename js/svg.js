...
//Circle with CSS class
//arguments
//=============================================================
//svgParent : SVG element where the object will be added
//Center : starting point (x, y)
//radius : size of the rectangle (width, height)
//cssClass : CSS class name that will be applied to the element
//id : id tag of the element (optional)
function drawCircleClass(svgParent, center, radius, cssClass, id) {
	//create element
	...
	//id
	if (typeof id !== 'undefined') circle.setAttribute('id', id);
	//add to parent
